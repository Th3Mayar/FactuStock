...
{
    public partial class ConsultarClientesGral : Form
    {
        public int vidcliente = 0, vtieneparametro = 0, indice = 0;
        public string valorparametro = "", mensaje = "";
        CNCliente objCliente = new CNCliente();

        public ConsultarClientesGral()
        {
            InitializeComponent();
        }
        ...
        private void ConsultarClientesGral_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void ConsultarClientesGral_Load(object sender, EventArgs e)
        {
            valorparametro = "";
            vtieneparametro = 0;
