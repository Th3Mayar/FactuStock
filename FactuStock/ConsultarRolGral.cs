...
{
    public partial class ConsultarRolGral : Form
    {
        public int vidrol = 0, vtieneparametro = 0, indice = 0;
        public string valorparametro = "", mensaje = "";
        CNRol objRol = new CNRol();

        public ConsultarRolGral()
        {
            InitializeComponent();
        }
        ...
        private void ConsultarRolGral_Load(object sender, EventArgs e)
        {
            valorparametro = "";
            vtieneparametro = 0;
        ...
        private void MostrarDatos()
        {
            ...
            LCantRoles.Text = Convert.ToString(DGVDatos.RowCount); //Se muestra la cantidad de datos
        ...
        private void ConsultarRolGral_FormClosing(object sender, FormClosingEventArgs e)
        {
