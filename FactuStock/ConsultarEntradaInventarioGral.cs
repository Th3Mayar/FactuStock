...
{
    public partial class ConsultarEntradaInventarioGral : Form
    {
        public int videntrada = 0, vtieneparametro = 0, indice = 0;
        public string valorparametro = "", mensaje = "";
        CNEntradaInventario objEntradaInventario = new CNEntradaInventario();

        public ConsultarEntradaInventarioGral()
        {
            InitializeComponent();
        }
        ...
        private void MostrarDatos()
        {
            ...
            if (objEntradaInventario.ObtenerEntradaInventario(valorparametro) != null)
            {
                DGVDatos.DataSource = objEntradaInventario.ObtenerEntradaInventario(valorparametro);
            ...
            LCantEntradas.Text = Convert.ToString(DGVDatos.RowCount); //Se muestra la cantidad de datos
        ...
        private void ConsultarEntradaInventarioGral_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void ConsultarEntradaInventarioGral_Load(object sender, EventArgs e)
        {
            valorparametro = "";
            vtieneparametro = 0;
