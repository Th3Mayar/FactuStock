...
{
    public partial class ConsultarEmpleadosGral : Form
    {
        public int vidempleado = 0, vtieneparametro = 0, indice = 0;
        public string valorparametro = "", mensaje = "";
        CNEmpleado objEmpleado = new CNEmpleado();

        public ConsultarEmpleadosGral()
        {
            InitializeComponent();
        }
        ...
        private void MostrarDatos()
        {
            ...
            LCantEmpleados.Text = Convert.ToString(DGVDatos.RowCount); //Se muestra la cantidad de datos
        ...
        private void ConsultarEmpleadosGral_Load(object sender, EventArgs e)
        {
            valorparametro = "";
            vtieneparametro = 0;
        ...
        private void ConsultarEmpleadosGral_FormClosing(object sender, FormClosingEventArgs e)
        {
