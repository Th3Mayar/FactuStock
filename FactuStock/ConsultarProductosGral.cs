...
{
    public partial class ConsultarProductosGral : Form
    {
        public int vidproducto = 0, vtieneparametro = 0, indice = 0;
        public string valorparametro = "", mensaje = "";
        CNProducto objProducto = new CNProducto();

        public ConsultarProductosGral()
        {
            InitializeComponent();
        }
        ...
        private void MostrarDatos()
        {
            ...
            LCantProductos.Text = Convert.ToString(DGVDatos.RowCount); //Se muestra la cantidad de datos
        ...
        private void ConsultarProductosGral_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void ConsultarProductosGral_Load(object sender, EventArgs e)
        {
            valorparametro = "";
            vtieneparametro = 0;
