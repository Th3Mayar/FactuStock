...
{
    public partial class ConsultarCondicionesGral : Form
    {
        public int vidcondicion = 0, vtieneparametro = 0, indice = 0;
        public string valorparametro = "", mensaje = "";
        CNCondicionProducto objCondicion = new CNCondicionProducto();

        public ConsultarCondicionesGral()
        {
            InitializeComponent();
        }
        ...
        private void MostrarDatos()
        {
            ...
            if (objCondicion.ObtenerCondicionProducto(valorparametro) != null)
            {
                DGVDatos.DataSource = objCondicion.ObtenerCondicionProducto(valorparametro);
            ...
            LCantCondiciones.Text = Convert.ToString(DGVDatos.RowCount); //Se muestra la cantidad de datos
        ...
        private void ConsultarCondicionesGral_Load(object sender, EventArgs e)
        {
            valorparametro = "";
            vtieneparametro = 0;
        ...
        private void ConsultarCondicionesGral_FormClosing(object sender, FormClosingEventArgs e)
        {
