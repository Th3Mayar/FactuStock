...
{
    public partial class ConsultarVentaGral : Form
    {
        public int vidventa = 0, vtieneparametro = 0, indice = 0;
        public string valorparametro = "", mensaje = "";
        CNVentaCabecera objVentaCabecera = new CNVentaCabecera();

        public ConsultarVentaGral()
        {
            InitializeComponent();
        }
        ...
        private void MostrarDatos()
        {
            ...
            if (objVentaCabecera.ObtenerVentaCabecera(valorparametro) != null)
            {
                DGVDatos.DataSource = objVentaCabecera.ObtenerVentaCabecera(valorparametro);
            ...
            LCantVenta.Text = Convert.ToString(DGVDatos.RowCount); //Se muestra la cantidad de datos
