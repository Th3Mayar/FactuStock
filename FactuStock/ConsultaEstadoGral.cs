...
namespace FactuStock
{
    ...
    {
        public int videstado = 0, vtieneparametro = 0, indice = 0;
        public string valorparametro = "", mensaje = "";
        CNEstado objEstado = new CNEstado();
        ...
        private void ConsultaEstadoGral_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void MostrarDatos()
        {
            ...
            if (objEstado.ObtenerEstado(valorparametro) != null)
            {
                DGVDatos.DataSource = objEstado.ObtenerEstado(valorparametro);
            ...
            LCantEstado.Text = Convert.ToString(DGVDatos.RowCount); //Se muestra la cantidad de datos
